...
$(function() {
  ...
  $(".edit").on("click", function() {
    ...
    $("#inputMarketingImg").addClass("show");
    $(".edit").html("SAVE");
    $(".edit").on("click", function() {
      $(".contentedit").attr("contenteditable", false);
      $("#inputMarketingImg").removeClass("show");
      $(".edit").hide();
    });
  });

  // image change
  var bannerImage = document.getElementById("inputMarketingImg");
  var result = document.getElementById("marketingRes");
  var img = document.getElementById("marketingImg");
